...
var css_248z$l = ".el_table_wrapper[data-v-86ca54f4]{display:flex;flex-direction:column}.el_table_wrapper .table_container[data-v-86ca54f4]{flex-grow:1;padding:0 6px;box-sizing:border-box}";
...
var css_248z$1 = ".tree-wrap[data-v-4f42a7d6]{height:100%;overflow-x:hidden;overflow-y:auto}.tree-node[data-v-4f42a7d6]{width:100%;height:100%;padding-right:10px;display:flex;box-sizing:border-box;justify-content:space-between;align-items:center;font-size:13px;overflow:hidden}.tree-node-content[data-v-4f42a7d6]{flex:1;display:flex;justify-content:space-between;align-items:center;overflow:hidden}.tree-node-content .content-left[data-v-4f42a7d6]{flex:1;display:flex;align-items:center;margin-right:10px;overflow:hidden}.tree-node-content .content-left .blank[data-v-4f42a7d6]{width:5px;height:5px;border-radius:5px;margin-right:3px}.tree-node-content .content-left .blank.red-circle[data-v-4f42a7d6]{background-color:#f56c6c}.tree-node-content .content-left .label[data-v-4f42a7d6]{flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.tree-node-content .content-right[data-v-4f42a7d6]{min-width:10px;display:flex;align-items:center;justify-content:flex-end;overflow:hidden}.tree-node-content .content-right .el-button[data-v-4f42a7d6],.tree-node-content .content-right .el-link[data-v-4f42a7d6],.tree-node-content .content-right i[data-v-4f42a7d6],.tree-node-content .content-right img[data-v-4f42a7d6]{margin-left:10px}[data-v-4f42a7d6] .el-tree-node__content{height:36px;position:relative}[data-v-4f42a7d6] .el-tree-node__content>.el-tree-node__expand-icon{z-index:12;padding:4px;display:inline-block}[data-v-4f42a7d6] .el-tree-node.is-current>.el-tree-node__content{background-color:#f2f6ff!important}[data-v-4f42a7d6] .el-tree-node:focus>.el-tree-node__content{background-color:transparent}";
...
/* scoped */
const __vue_scope_id__$1 = "data-v-4f42a7d6";
/* module identifier */
