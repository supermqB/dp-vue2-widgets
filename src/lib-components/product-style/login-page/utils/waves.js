...
;(function () {
  ...
  Waves.prototype.background = function () {
    ...
    // gradient.addColorStop(1, '#353d58');
    // ctx.fillStyle = gradient;

    ctx.fillStyle = '#353d58'
  ...
  Waves.prototype.updateColor = function () {
    ...
    var gradient = Waves.ctx.createLinearGradient(0, 0, Waves.width, 0)
    gradient.addColorStop(0, '#353d58')
    gradient.addColorStop(0.3, '#3c4661')
    gradient.addColorStop(0.7, '#3c4661')
    gradient.addColorStop(1, '#353d58')

    // Waves.color = '#3a4560';
    Waves.color = gradient
  }
